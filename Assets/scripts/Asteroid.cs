...
public class Asteroid : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D coll)
    {
        ...
        {   if (gameObject.transform.localScale.x == 1)
            {
                Vector3 newScale = new Vector3(gameObject.transform.localScale.x / 2, gameObject.transform.localScale.y / 2, gameObject.transform.localScale.z / 2);
                ...
                GameObject small1 = Instantiate<GameObject>(gameObject);
                Asteroid script1 = small1.GetComponent<Asteroid>();
                script1.Initialize(Direction.Right, newLocation);
                GameObject small2 = Instantiate<GameObject>(gameObject);
                Asteroid script2 = small2.GetComponent<Asteroid>();
                script2.Initialize(Direction.Left, newLocation);
